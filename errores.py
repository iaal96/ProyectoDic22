...
class Error:
	...
	def syntax(t, lineno):
		" error sintactico "
		print("Error: Token '%s' inesperado en la linea %d" % (t, lineno))
		exit(0)
	...
	def return_on_void_function(t, lineno):
		print("Error: regresa en funcion void en la linea %d." % (lineno))
		exit(0)

	@staticmethod
	def no_return_on_function(t, lineno):
		print("Error: no hay regresa en funcion con tipo regresa en la linea %d." % (lineno))
		exit(0) 
	...
	def index_out_of_bounds(lineno):
		print("Error en Ejecucion: indice fuera del rango en la linea %d." % (lineno))
		exit(0)
	...
	def type_mismatch_on_return(lineno):
		print("Error: type mismatch en regresa en en la linea %d." % (lineno))
		exit(0) 